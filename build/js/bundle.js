...
module.exports = function () {
  var menu = document.querySelector('.header-navigation__list-wrap'),
...
$(document).ready(function () {
  $(".promo-slider").on('init afterChange', function (event, slick) {
    var currentSlide = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 0;
    var slider = slick.$slides[currentSlide];
...
module.exports = function (slide) {
  var bindTabs = function bindTabs(triggerSelector, contentSelector, activeSelector) {
    var trigger = slide.querySelectorAll(triggerSelector);
    var content = slide.querySelector(contentSelector);
    var active = activeSelector;

    var child = _toConsumableArray(content.children);
